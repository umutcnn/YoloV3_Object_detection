...
# kullanacağınız goruntunun url'sini tanimliyoruz
url = "http://192.168.1.21:8080/shot.jpg"


while True:

    #yukarida belirledigimiz url den goruntu aliyoruz
    img_resp = requests.get(url)
    #alinan goruntuyu bir diziye donusturuyoruz
    img_arr = np.array(bytearray(img_resp.content), dtype=np.uint8)
    #algigimiz goruntuyu diziye ceviriyoruz
    ...
    # OpenCV penceresinde goruntuyu gosteriyoruz
